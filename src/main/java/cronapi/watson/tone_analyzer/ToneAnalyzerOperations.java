...
public final class ToneAnalyzerOperations {
  ...
  @CronapiMetaData
  public static ToneAnalysis tone(String versionDate, String username, String password,
      String endPoint,
  ...
  @CronapiMetaData
  public UtteranceAnalyses toneChat(String versionDate, String username, String password,
      String endPoint,
